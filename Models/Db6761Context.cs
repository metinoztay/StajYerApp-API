...
public partial class Db6761Context : DbContext
{
    ...
    public virtual DbSet<CompanyUserForgotPassword> CompanyUserForgotPasswords { get; set; }
    ...
    public virtual DbSet<UserFollowedCompany> UserFollowedCompanies { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CompanyUserForgotPassword>(entity =>
        {
            entity.HasKey(e => e.ForgotId);

            entity.ToTable("CompanyUserForgotPassword");
            ...
            entity.HasOne(d => d.CompUser).WithMany(p => p.CompanyUserForgotPasswords)
                .HasForeignKey(d => d.CompUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CompanyUserForgotPassword_CompanyUsers");
        });
        ...
        modelBuilder.Entity<UserFollowedCompany>(entity =>
        {
            entity.HasKey(e => e.FollowId).HasName("PK__UserFollowedCompanies");

            entity.HasOne(d => d.Comp).WithMany(p => p.UserFollowedCompanies)
                .HasForeignKey(d => d.CompId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserFollowedCompanies_Companies");

            entity.HasOne(d => d.User).WithMany(p => p.UserFollowedCompanies)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserFollowedCompanies_Users");
        });
